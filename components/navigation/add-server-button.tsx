...
export default function AddServerButton() {
  ...
  return (
    <ActionTooltip side="right" align="start" label="Add a server">
      <button
        onClick={handleOpen}
        className="group flex justify-center items-center text-emerald-500 bg-grayish rounded-[24px] hover:rounded-[20px] size-12 hover:bg-emerald-400 transition-all"
      >
